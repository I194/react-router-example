    ...
    <div className={styles.container}>
      ...
      <div className={styles.about}>
        ...
        <ol>
          ...
          <li>Сервер отправляет ответ в котором находится либо запрошенный ресурс, либо ошибка</li>
        </ol>
...
`}
        ...
        <p>Сейчас мы находимся на главной странице (Main Page), расположенной по адресу <code>'/'</code>. Это самый базовый из маршрутов и он является обычным, не динамическим. Увидеть в коде это можно, если посмотреть на первый из роутов (Route):</p>
        <pre><code>
          {`<Route path='/' element={<MainLayout />}>
  <Route index element={<MainPage />}/>
  <Route path='about' element={<AboutPage />}/>
